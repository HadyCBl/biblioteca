...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<td>" . $row["segundo_n"] . "</td>";
        echo "<td>" . $row["apellido"] . "</td>";
        echo "<td>" . $row["segundo_a"] . "</td>";
        echo "<td>" . $row["direccion"] . "</td>";
        echo "<td>" . $row["fecha_n"] . "</td>";
        echo "<td>";
        echo "<a href=\"eliminar_cliente.php?id=" . $row["id"] . "\" onclick=\"return confirm('¿Estás seguro de que deseas borrar este cliente?')\">Eliminar</a>";
        echo "<a href=\"actualizar_cliente.php?id=" . $row["id"] . "\">/Actualizar</a>";
        echo "</td>";
        echo "</tr>";
    }
    echo "</table>";
